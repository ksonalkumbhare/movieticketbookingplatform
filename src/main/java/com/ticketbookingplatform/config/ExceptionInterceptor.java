package com.ticketbookingplatform.config;
...
public class ExceptionInterceptor {
	...
	public ResponseEntity<String> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
		...
		logger.error("Got MethodArgumentNotValidException: ", e);
	...
	public ResponseEntity<String> handlePropertyAccessException(PropertyAccessException e) {
		...
		logger.error("Got PropertyAccessException:", e);
	...
	public ResponseEntity<String> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e) {
		...
		logger.error("Got MethodArgumentTypeMismatchException: ", e);
	...
	public ResponseEntity<String> handleMissingServletRequestParameterException(MissingServletRequestParameterException e) {
		...
		logger.error("Got MissingServletRequestParameterException: ", e);
	...
	public ResponseEntity<String> handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
		...
		logger.error("Got HttpMessageNotReadableException: ", e);
	...
	public ResponseEntity<String> handleInvalidFormatException(InvalidFormatException e) {
		...
		logger.error("Got InvalidFormatException: ", e);
	...
	public ResponseEntity<String> handleSQLIntegrityConstraintViolationException(SQLIntegrityConstraintViolationException e) {
		...
		logger.error("Got SQLIntegrityConstraintViolationException:", e);
	...
	public ResponseEntity<String> handleConstraintViolationException(ConstraintViolationException e) {
		...
		logger.error("Got ConstraintViolationException: ", e);
	...
	public ResponseEntity<String> handleDataIntegrityViolationException(DataIntegrityViolationException e) {
		...
		logger.error("Got DataIntegrityViolationException:", e);
	...
	public ResponseEntity<String> handleDuplicateRecordException(DuplicateRecordException e) {
		...
		logger.error("Got DuplicateRecordException: ", e);
	...
	public ResponseEntity<String> handleEntityNotFoundException(EntityNotFoundException e) {
		...
		logger.error("Got EntityNotFoundException: ", e);
	...
	public ResponseEntity<String> handleDependencyException(DependencyException e) {
		...
		logger.error("Got DependencyException: ", e);
